...
import 'package:graphql_flutter_examplev2/mutations/mutations.dart';
import 'package:graphql_flutter_examplev2/queries/readRepositories.dart';
...
void query() async {
  ...
  if (result.hasException) {
    stderr.writeln(result.exception);
    exit(2);
  }
  ...
  repositories.forEach(
          (dynamic f) {
            return stdout.writeln('Idx: ${f['id']} Name: ${f['name']}');
          });
